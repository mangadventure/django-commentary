...
from commentary.models import Comment, CommentFlag
...
class AdminActionsTests(CommentTestCase):
    ...
    def setUp(self):
        ...
        perms = Permission.objects.filter(
            content_type__app_label='commentary',
    ...
    def testActionsNonModerator(self):
        ...
        self.client.login(username="normaluser", password="normaluser")
        response = self.client.get("/admin/commentary/comment/")
    ...
    def testActionsDisabledDelete(self):
        ...
        self.createSomeComments()
        self.client.login(username="normaluser", password="normaluser")
        response = self.client.get('/admin2/commentary/comment/')
        self.assertEqual(response.status_code, 200)
    ...
    def performActionAndCheckMessage(self, action, action_params, expected_message):
        response = self.client.post('/admin/commentary/comment/',
